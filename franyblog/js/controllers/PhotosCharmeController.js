app.controller('PhotosCharmeController',['ngDialog','$scope','peticionesFactory',async (ngDialog,$scope, peticionesFactory)=>{
    $scope.ubicacion='#!/photosCharme';
    $scope.fotoSelecionada;
    $scope.fotoSelecionadaIndex;

    let fotos = await peticionesFactory.obtenerFotos('charme');
